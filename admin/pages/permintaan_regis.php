...
// Query untuk mengambil data pengguna dengan status 'pending'
$query = "SELECT id, nama_lengkap, email, role, status FROM users WHERE status = 'pending'";
...
<head>
    ...
    <title>Permintaan Registrasi</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container my-4">
    <h5>Permintaan Registrasi Akun</h5>
                ...
                while ($row = $data->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='detail_users.php?id={$row['id']}' class='btn btn-info btn-sm'>Detail</a>
                            </td>
                        </tr>";
                    $no++;
                }
